...
namespace psms.SQLServerDAL
{
    ...
    public class OutTable : IOutTable
    {
        ...
        /// </summary>
        private const string SQL_SELECT_TOP_OUT_SCRPNO = "SELECT TOP 1 OUT_SCRPNO FROM OUTTABLE WHERE CHARINDEX('-',OUT_SCRPNO,6) = 0 AND ISNUMERIC(REPLACE(out_scrpno,'-','')) = 1 ORDER BY CONVERT(int,REPLACE(out_scrpno,'-','')) DESC";
