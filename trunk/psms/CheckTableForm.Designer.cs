namespace psms
{
    partial class CheckTableForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CheckTableForm));
            ...
            this.groupBoxCheckTable.Text = "盘存内容";
            // 
            // btnClose
            // 
            ...
            this.Text = "宣传品盘存";
            this.Load += new System.EventHandler(this.CheckTableForm_Load);
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.CheckTableForm_FormClosed);
